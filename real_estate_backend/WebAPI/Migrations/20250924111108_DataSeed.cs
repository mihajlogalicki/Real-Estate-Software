    ...
    public partial class DataSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                insert into Properties(SellRentType,Name,PropertyTypeId,FurnishingTypeId,Price,BuiltArea,CarpetArea,Address,CityId,FloorNo,TotalFloors,ReadyToMove,MainEntrance,Security,Gated,Maintenance,EstablishedPossesionOn,Age,Description,PostedOn,PostedBy,LastUpdatedOn,LastUpdatedBy)
                select 
                1, --Sell Rent
