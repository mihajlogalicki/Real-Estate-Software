...
{
    /// <inheritdoc />
    public partial class AddedRemainingEntitiesAndRelationship : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SellRentType = table.Column<int>(type: "int", nullable: false),
                    ...
                    EstablishedPossesionOn = table.Column<DateTime>(type: "datetime2", nullable: false),
